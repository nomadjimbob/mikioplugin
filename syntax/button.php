 ...
 *
 * Syntax:  <BUTTON [primary|secondary|success|danger|warning|info|light|dark] [url] [target] [newtab] [collapse-id] [nowrap]></BUTTON>
 * 
...
class syntax_plugin_mikioplugin_button extends syntax_plugin_mikioplugin_core {
    ...
    public function render_lexer_enter(Doku_Renderer $renderer, $data) {
        $classes = $this->buildClassString($data, array('type', 'size', 'block', 'active', 'disabled', 'nowrap'), array('btn-' => array('type', 'size', 'block'), 'text-' => 'nowrap'));
